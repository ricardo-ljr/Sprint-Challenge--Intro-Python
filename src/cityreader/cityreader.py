...
def cityreader(cities=[]):
    ...
    with open('/Users/ricardoleitejr/Desktop/Lambda/CS30/Unit 1/Sprint-Challenge--Intro-Python/src/cityreader/cities.csv', 'r') as csvfile:
        cities_file = csv.reader(csvfile, delimiter=",")
        next(cities_file)
...
# Normalize input data
    ...
    within = []
    for city in cities:
        if lower_left <= city.lat <= upper_right and upper_left <= city.lon <= lower_right:
            within.append(city)
